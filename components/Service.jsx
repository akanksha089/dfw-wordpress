                    ...
                    <div className="section-heading text-center">
                        ...
                        >
                            <div className="line" style={{ display: 'block', textAlign: 'center', width: '100%' }}>
                                {splitText(service && service.subtitle)} 
                            </div>
                        </h2>

                    </div>
                    <div className="row gy-lg-0 gy-4 single-service">
                        {data && data.length > 0 ? (
                            data.map((item, index) => (
                                <div key={index} className="col-lg-3 col-md-6 ">
                                    <div className="service-item md-pb-30 fade-top pb-60  ">
                                        ...
                                        <div className="service-thumb">
                                            ...
                                            <img src={item && item.image ? item.image : 'assets/img/service/service-1.jpg'} alt="service" />
                ...
                <div className="container">
                        ...
                        <div className="section-heading mb-0">
                            ...
                            >
                                <div className="line" style={{ display: 'block', textAlign: 'start', width: '100%' }}>
                                    {splitText(service && service.subtitle)} {/* Dynamically render subtitle here */}
                                </div>
                            </h2>

                        </div>
                        <Link href="/services" className="rr-primary-btn">
                            View More Service<i className="fa-regular fa-arrow-right"></i>
                        </Link>
                    </div>
                    <div className="project-accordion">
                        <div className="accordion" id="projectAccordion">
                            {data && data.length > 0 ? (
                                data.map((item, index) => (
                                    <div key={index} className="accordion-item project-item project-color">
