                                ...
                                <div className="container">
                                    <div className="section-heading text-center">
                                        ...
                                        <h2
                                            ...
                                            data-duration="1"
                                        >
                                            We Provide Amazing Web <br /> Design Solutions
                                        </h2>
                                    </div>
                                        ...
                                        {[
                                            ...
                                            <div className="col-md-6" key={idx}>
                                                <div className="service-card fade-top">
                                                    <div className="shape">
                                                        <img
                                                            src="assets/img/shapes/service-shape-2.png"
                                                            alt="service"
                                                        />
                                                    </div>
                                                    <div className="icon">
                                                        <img src={`/assets/img/icon/${service.icon}`} alt="service" />
                                                    </div>
                                                    <div className="content">
                                                        <h3 className="title">{service.title}</h3>
                                                        <p>
                                                            This strategy encompasses a wide range of activities, from <br /> online marketing and social media to website...
                                                        </p>
                                        ...
                                        <div className="service-box-wrap fade-top">
                                            <div className="service-box">
                                                ...
                                                <div className="service-img">
                                                    <img src="/assets/img/service/service-img-1.png" alt="service" />
                                                </div>
                                            </div>
                                            <div className="service-box">
                                                ...
                                                <div className="service-img">
                                                    <img src="/assets/img/service/service-img-2.png" alt="service" />
                                                </div>
                                            </div>
                                            <div className="service-box">
                                            ...
                                            <div className="service-box">
                                                ...
                                                <div className="icon">
                                                    ...
                                                    >
                                                        ...
                                                        <path d="M32.1835 22.6054L26.4765 28.3125L32.1835 34.0196L33.5978 32.6054L29.3048 28.3125L33.5978 24.0196L32.1835 22.6054Z" />
                                                        <path d="M36.0251 32.8446L41.0288 23.8462L42.7767 24.8182L37.773 33.8166L36.0251 32.8446Z" />
                                                        <path d="M44.1835 24.0196L48.4765 28.3125L44.1835 32.6054L45.5978 34.0196L51.3047 28.3125L45.5978 22.6054L44.1835 24.0196Z" />
                                                ...
                                                <div className="service-img">
                                                    <img src="/assets/img/service/service-img-4.png" alt="service" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
