            ...
            allParagraphs.forEach((p) => {
                ...
                if (strong) {
                    ...
                    if (title && description) {
                        extractedServices.push({ title, description });
                    }
                }
            });
                                ...
                                <div className="container">
                                    <div className="section-heading text-center">
                                        ...
                                        <h2
                                            ...
                                            data-duration="1"
                                        >
                                            We Provide Amazing  <br /> {data && data.title ? data.title : ""} Services
                                        </h2>
                                    </div>
                                    <div className="row gy-4 fade-wrapper">
                                    {services.slice(0, services.length / 1.5).map((service, idx) => (
                            ...
                            <section className="service-section-3 pb-130 fade-wrapper">
                                <div className="container">
                                    <div className="row gy-lg-0 gy-4">
                                        ...
                                        {services.slice(services.length / 1.5).map((service, idx) => (
